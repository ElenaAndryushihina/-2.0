...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var playerButton = document.querySelector('.gym__button-play');
...
},{"./modules/accordions/init-accordions":3,"./modules/form-validate/form":5,"./modules/modals/init-modals":11,"./modules/tabs/init-tabs":13,"./utils/ios-vh-fix":17}],2:[function(require,module,exports){
"use strict";
